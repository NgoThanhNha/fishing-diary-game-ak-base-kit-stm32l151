...
/* define game timer */
#define FD_GAME_TIME_TICK_INTERVAL									(100)
...
/*****************************************************************************/
/*                     FISHING DIARY GAME task define                        */
/*****************************************************************************/
enum{
	FD_GAME_TIME_TICK = FD_GAME_DEFINE_SIG,

};

enum{
	FD_GAME_GUN_SETUP = FD_GAME_DEFINE_SIG,
	FD_GAME_GUN_UPDATE,
	FD_GAME_GUN_LEFT,
	FD_GAME_GUN_RIGHT,
};
...
enum{
	FD_GAME_BULLET_SETUP = FD_GAME_DEFINE_SIG,
...
enum{
	FD_GAME_FISH_SETUP = FD_GAME_DEFINE_SIG,
	FD_GAME_FISH_UPDATE,
	FD_GAME_FISH_MOTION,
	FD_GAME_FISH_RESET,
};
