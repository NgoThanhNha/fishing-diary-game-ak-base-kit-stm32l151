...
/* --------------------------------------------- */
/*           FISHING DIARY GAME HANDLE           */
/* --------------------------------------------- */
extern void fd_game_gun_handle(ak_msg_t* msg);
extern void fd_game_bullet_handle(ak_msg_t* msg);
extern void fd_game_fish_handle(ak_msg_t* msg);
